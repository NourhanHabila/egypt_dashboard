...
if page == "🏠 Overview":
    ...
    brent_f     = filt(brent_df)
    latest_brent= brent_f["price_usd"].iloc[-1] if len(brent_f) else brent_df["price_usd"].iloc[-1]
    prev_brent  = brent_f["price_usd"].iloc[-2] if len(brent_f) > 1 else brent_df["price_usd"].iloc[-2]
